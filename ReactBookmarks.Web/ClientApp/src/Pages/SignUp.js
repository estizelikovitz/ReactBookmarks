...
const SignUp = () => {
    ...
    const [user, setUser] = useState({ firstName: '', lastName: '', email: '', passwordHash: '' });
    ...
    const onSubmitClick = async (e) => {
        e.preventDefault();
        await axios.post('/api/bookmarks/adduser', user);
        history.push('/login');
        ...
        <div className="row" style={{ minHeight: 80 }}>
                ...
                <h3>Sign up for a new account</h3>
                    <form onSubmit={onSubmitClick}>
                        <input type="text" value={firstName} name="firstName" placeholder="First Name" className="form-control" onChange={onTextChange}/>
                    <br />
